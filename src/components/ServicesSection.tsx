...
export default function ServicesSection({ language, onSelectServiceForInquiry }: ServicesSectionProps) {
  ...
  return (
    <section id="services" className="py-16 sm:py-24 border-b border-[#064E3B]/20 dark:border-[#059669]/30 bg-[#F0F7F3] dark:bg-[#050E09]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Section Header */}
        <div className="max-w-3xl mb-14">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-[4px] text-xs font-semibold bg-[#FBFDFB] dark:bg-[#0E2017] text-[#064E3B] dark:text-[#A7F3D0] border border-[#064E3B]/30 dark:border-[#059669] mb-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
          {t.services.map((service: ServiceItem, idx: number) => (
            <div
              key={service.id}
              className="rounded-[4px] p-5 sm:p-6 bg-[#FFFFFF] dark:bg-[#0E2017] border-t-2 border-t-[#064E3B] dark:border-t-[#059669] border-r border-b border-l border-[#064E3B]/20 dark:border-[#059669]/30 shadow-2xs hover:border-[#064E3B] dark:hover:border-[#34D399] transition-all duration-150 flex flex-col justify-between group"
            >
              <div>
                {/* Header with Icon & Index */}
                <div className="flex items-center justify-between mb-4">
                  <div className="p-2.5 rounded-[4px] bg-[#F0F7F3] dark:bg-[#0A1710] text-[#064E3B] dark:text-[#34D399] border border-[#064E3B]/30 dark:border-[#059669]/40 group-hover:bg-[#064E3B] group-hover:text-white dark:group-hover:bg-[#059669] dark:group-hover:text-[#022C22] transition-colors">
                    {iconMap[service.iconName] || <Boxes className="w-5 h-5" />}
                  </div>
                  <span className="text-xs text-[#064E3B] dark:text-[#6EE7B7] font-bold">
                    ۰{idx + 1}
                  </span>
                </div>
                ...
                <div className="space-y-1.5 mb-5">
                  <div className="text-[11px] font-bold text-[#064E3B] dark:text-[#6EE7B7]">
              ...
              <div className="pt-4 border-t border-[#064E3B]/15 dark:border-[#059669]/25 mt-2">
                ...
                <a
                  ...
                  className="inline-flex items-center justify-between w-full px-3.5 py-2 text-xs font-bold rounded-[4px] bg-[#F0F7F3] dark:bg-[#0A1710] text-[#064E3B] dark:text-[#6EE7B7] hover:bg-[#064E3B] hover:text-white dark:hover:bg-[#059669] dark:hover:text-[#022C22] transition-colors border border-[#064E3B]/40 dark:border-[#059669] cursor-pointer"
                >
